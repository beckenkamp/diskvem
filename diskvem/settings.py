# Django settings for diskvem project.
...
SECRET_KEY = '$^qo27ug53vz+mtpv!=!$6vwj!u6cq)kquolro)urpuldg3)0h'
...
ROOT_URLCONF = 'diskvem.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'diskvem.wsgi.application'
